...
void setup() {
  ...
  // ---------- Microphone ----------
  // TODO: fix microphone code with new I2S driver that replaced the legacy I2S driver
  Serial.println("Microphone Test => Currently there is a software bug that prevents the microphone from being tested.");
  // Serial.println();
